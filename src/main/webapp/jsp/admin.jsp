...
<main role="main" class="container">
    ...
    <button id="send" class="btn btn-primary btn-lg btn-space" type="submit" onClick='location.href="/addorder?limit1=0&limit2=5"'>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" href="/addorder?limit1=0&limit2=5">1</a></li>
