...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" >
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item ">
                <a class="nav-link"  href="#" ><img src="https://img.icons8.com/color/48/000000/russian-federation.png" height="35px"><span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="#" ><img src="https://img.icons8.com/color/48/000000/usa.png" height="40px"><span class="sr-only">(current)</span></a>
            </li>
<%--            <li class="nav-item dropdown">--%>
<%--                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">--%>
<%--                    <img src="https://img.icons8.com/color/48/000000/usa.png"><img src="https://img.icons8.com/color/48/000000/russian-federation.png">--%>
<%--                </a>--%>
...
<main role="main" class="container">
    ...
    <button class="btn btn-primary btn-lg btn-space" type="submit" onClick='location.href="javascript:sh2()"'><fmt:message key="send.message" /></button>
